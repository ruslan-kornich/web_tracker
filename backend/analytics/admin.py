...
class CampaignAdmin(admin.ModelAdmin):
    list_display = ('name', 'start_date', 'end_date', 'budget', 'created_at', 'updated_at')
...
class ClickAdmin(admin.ModelAdmin):
    list_display = (
    'offer', 'user_ip', 'user_agent', 'os', 'browser', 'click_time', 'landing_page_url', 'created_at', 'updated_at')
